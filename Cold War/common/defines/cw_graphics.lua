...
NDefines_Graphics.NGraphics.VICTORY_POINT_MAP_ICON_TEXT_CUTOFF = {300, 500, 700}  -- At what camera distance the VP name text disappears
NDefines_Graphics.NGraphics.VICTORY_POINT_MAP_ICON_AFTER = {0, 12}
NDefines_Graphics.NGraphics.UNITS_ICONS_DISTANCE_CUTOFF = 500
NDefines_Graphics.NGraphics.SUN_HEIGHT  = 600
NDefines_Graphics.NGraphics.SUN_LATITUDE  = 848
NDefines_Graphics.NGraphics.SUN_HEIGHT_WATER = 5000
NDefines_Graphics.NGraphics.SUN_DIFFUSE_COLOR   = {0.06, 0.4, 1.1}
NDefines_Graphics.NGraphics.SUN_INTENSITY 		= 0.9; -- 0.4
